...
public class AdminServiceLocator extends org.apache.axis.client.Service implements annuaire1.AdminService {
    ...
    public annuaire1.Admin getAdmin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            annuaire1.AdminSoapBindingStub _stub = new annuaire1.AdminSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (annuaire1.Admin.class.isAssignableFrom(serviceEndpointInterface)) {
                annuaire1.AdminSoapBindingStub _stub = new annuaire1.AdminSoapBindingStub(new java.net.URL(Admin_address), this);
                _stub.setPortName(getAdminWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://annuaire1", "AdminService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://annuaire1", "Admin"));
        }
